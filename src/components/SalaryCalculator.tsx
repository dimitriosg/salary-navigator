    ...
    <Card className="w-full">
      ...
      <CardContent>
        <div className="grid gap-6 md:grid-cols-3 items-start">
          <div className="md:col-span-1 space-y-4 p-4 bg-muted/40 rounded-xl border border-border/50">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">
              {language === 'el'
                ? 'Οι κρατήσεις και τα φορολογικά κλιμάκια υπολογίζονται με βάση τα δηλωμένα τέκνα.'
                : 'Deductions and tax brackets are calculated based on declared children.'}
            </p>
          </div>

          <div className="space-y-4 p-4 rounded-xl border border-border/60 shadow-sm bg-card/50">
